require 'projectvinyl/search/parser/user_id_cache'
require 'projectvinyl/search/parser/range_query'
require 'projectvinyl/search/parser/text_query'
require 'projectvinyl/search/parser/vote_query'
        ...
        def take_all(opset, sender)
          until opset.length == 0
            ...
            if op == Op::OR
              ...
              child_group = QueryParser.new(self)
